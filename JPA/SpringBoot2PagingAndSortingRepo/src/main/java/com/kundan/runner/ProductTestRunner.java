...
public class ProductTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		productRepository.save(new Product(107,"HOST",5002.30,"REST"));
		productRepository.save(new Product(108,"GET",2002.30,"FETCH"));
		productRepository.save(new Product(109,"PUT",4003.60,"FETCH SINGLE"));
		...
		productRepository.save(new Product(113,"PARK",2000.30,"RENT"));
		productRepository.save(new Product(114,"KARMA",4200.60,"SAT"));
